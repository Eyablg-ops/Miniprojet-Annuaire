...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http.cors().and()
                ...
                .antMatchers(HttpMethod.GET, "/api/offers/public").permitAll()
                .antMatchers(HttpMethod.GET, "/api/offers/search").permitAll()
                .antMatchers("/api/annuaire/**").permitAll()
                ...
                // Recruiter endpoints - requires authentication
                .antMatchers("/api/recruiters/**").authenticated()
                .antMatchers("/api/recruiter/**").authenticated()
